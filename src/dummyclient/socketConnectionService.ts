...
export class SocketConnectionService {
    ...
    public async createConnection(userData: UserData): Promise<SocketIOClient.Socket | null> {
        ...
        await this.timeout(this.connectionInterval);
    ...
    public spellBattleStart(cardNo: number, targetUserId: number, spellOption) {
    ...
    public spellResponse(battleId: number, spellCardNo: number, spellOption?) {
